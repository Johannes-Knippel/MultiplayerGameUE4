...
#define UE_PROJECT_NAME JohnsMultiplayer
#define UE_TARGET_NAME JohnsMultiplayerEditor
#define UE_MODULE_NAME "JohnsMultiplayer"
...
#define JOHNSMULTIPLAYER_API DLLEXPORT
